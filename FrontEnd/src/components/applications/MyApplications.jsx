          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8">
            {["APPLIED", "SHORTLISTED", "SELECTED", "REJECTED"].map((s) => {
              ...
              return (
                <div
                  key={s}
                  className="bg-white/10 rounded-2xl p-4 backdrop-blur border border-white/10"
                >
                  <p className="text-2xl font-black">{counts[s] || 0}</p>
                  <p
                    className={`text-xs font-bold uppercase mt-1 ${style.bg.split(" ")[1]}`}
                  >
                    {s}
                  </p>
                </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-sm text-slate-500 truncate">
                      {drive?.jobRole} — {drive?.driveTitle}
                    </p>
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold ${style.bg}`}
                    >
                      <span
