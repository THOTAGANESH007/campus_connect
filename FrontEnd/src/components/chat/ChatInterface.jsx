...
const ChatInterface = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)] md:h-screen bg-gray-50 text-slate-800 overflow-hidden relative font-sans">
      ...
      <div className="absolute inset-0 bg-linear-to-br from-blue-50 via-white to-gray-50 -z-10" />
          ...
          {messages.map((message, index) => (
            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={`prose prose-sm md:prose-base max-w-none wrap-break-word ${message.role === "user" ? "prose-invert" : "prose-slate"}`}
                  >
