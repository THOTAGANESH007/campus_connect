  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-6 selection:bg-indigo-100 font-sans">
      <div className="max-w-3xl w-full">
        ...
        >
          <ArrowLeft size={16} className="group-hover:-translate-x-1 transition-transform" /> back  Dashboard
        </motion.button>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-12 space-y-10">
            ...
            <div className="space-y-4">
              ...
              <div
                className={`relative group cursor-pointer border-[3px] border-dashed rounded-[3rem] transition-all p-16 text-center ${file ? "border-emerald-400/50 bg-emerald-50/30" : "border-slate-100 hover:border-indigo-400/50 hover:bg-slate-50/50"
                  }`}
              >
                <input
                  type="file"
                ...
                <div className="flex flex-col items-center gap-6">
                  <div className={`w-24 h-24 rounded-[2rem] flex items-center justify-center transition-all duration-500 ${file ? "bg-emerald-500 text-white rotate-6 shadow-xl shadow-emerald-500/20" : "bg-white text-slate-300 group-hover:bg-indigo-500 group-hover:text-white group-hover:rotate-12 group-hover:shadow-xl shadow-indigo-500/20"
                    }`}>
