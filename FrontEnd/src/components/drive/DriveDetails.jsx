      ...
      <div className="min-h-screen flex items-center justify-center bg-slate-50">
        <div className="p-10 text-center bg-white rounded-3xl shadow-xl shadow-red-500/5 max-w-md">
          ...
          <p className="text-slate-500 font-medium mb-6">
            The drive you are looking for might have been deleted or removed.
          </p>
          <Link
            to="/drives"
            className="inline-flex items-center justify-center px-6 py-3 bg-slate-900 text-white font-bold rounded-xl hover:bg-slate-800 transition-all"
          >
            Go Back Home
          </Link>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] font-sans selection:bg-indigo-500/20 pb-20">
      ...
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="relative bg-slate-900 text-white min-h-100 overflow-hidden flex flex-col"
      >
        <div className="absolute inset-0 bg-linear-to-br from-indigo-900 via-slate-900 to-black opacity-90"></div>
        <div className="absolute top-0 right-0 w-125 h-125 bg-indigo-500/20 rounded-full blur-[128px] -translate-y-1/2 translate-x-1/2"></div>
        <div className="absolute bottom-0 left-0 w-100 h-100 bg-teal-500/10 rounded-full blur-[128px] translate-y-1/2 -translate-x-1/2"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 -mt-10 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            {/* Primary CTA Card */}
            <div className="bg-white rounded-4xl shadow-[0_20px_40px_rgb(0,0,0,0.08)] p-8 text-center border border-slate-100 relative overflow-hidden">
              ...
              <p className="text-5xl font-black text-slate-900 tracking-tight mb-8">
                {drive.ctc}
              </p>
            ...
            {/* Timeline Card */}
            <div className="bg-white rounded-4xl shadow-lg border border-slate-100 p-8">
              ...
              <div className="relative pl-2 space-y-8 before:absolute before:left-2.75 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-100">
                <div className="relative pl-8">
                  <div className="absolute left-1.25 top-1.5 w-3.5 h-3.5 rounded-full border-4 border-white bg-red-500 shadow-sm z-10"></div>
                  ...
                  <p className="text-sm text-slate-500">
                    {new Date(drive.registrationDeadline).getFullYear()}
                  </p>
                </div>
                <div className="relative pl-8">
                  <div className="absolute left-1.25 top-1.5 w-3.5 h-3.5 rounded-full border-4 border-white bg-indigo-500 shadow-sm z-10"></div>
                  <p className="text-xs font-bold text-indigo-500 uppercase tracking-wider mb-1">
                    Drive Begins
                  </p>
                  <p className="text-lg font-bold text-slate-900">
                    {new Date(drive.startDate).toLocaleDateString(undefined, {
                      day: "numeric",
                      month: "short",
                    })}
                  </p>
                  <p className="text-sm text-slate-500">
                    {new Date(drive.startDate).getFullYear()}
                  </p>
                </div>
                <div className="relative pl-8">
                  <div className="absolute left-1.25 top-1.5 w-3.5 h-3.5 rounded-full border-4 border-white bg-slate-300 shadow-sm z-10"></div>
            ...
            {/* Contact Card */}
            <div className="bg-slate-900 rounded-4xl shadow-xl p-8 text-white relative overflow-hidden group">
              {/* animated sheen */}
              ...
              <h3 className="font-bold mb-6 flex items-center relative z-10 text-lg">
                <Users className="mr-3 text-indigo-400" strokeWidth={2.5} />{" "}
                Contact Point
              </h3>
              <div className="space-y-1 relative z-10">
                ...
                <p className="text-white font-bold text-xl">
                  {drive.createdBy?.name || "Placement Cell"}
                </p>
          ...
          >
            {/* Description Card */}
            <section className="bg-white rounded-4xl shadow-sm border border-slate-100 p-8 md:p-10">
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm flex flex-col justify-between h-full">
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                      <div
                        ...
                        style={{ width: `${(drive.minCgpa / 10) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                  <div className="mt-6">
                    <p className="text-sm font-medium text-slate-500 mb-2">
                      Eligible Passout Batch
                    </p>
              ...
              <div className="bg-white p-8 rounded-4xl border border-slate-100 shadow-sm">
                ...
                <div className="flex flex-wrap gap-2">
                  {drive.eligibleBranches.map((branch) => (
                    <span
                      key={branch}
                      className="px-4 py-2 bg-slate-50 text-slate-700 font-bold rounded-xl border border-slate-100"
                    >
                      {branch}
                    </span>
                  ))}
                ...
                <div className="mt-8 pt-6 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div
                    className={`px-4 py-1.5 rounded-full font-bold text-sm ${drive.backlogsAllowed ? "bg-emerald-100 text-emerald-700" : "bg-red-100 text-red-700"}`}
                  >
            ...
            <section className="bg-white rounded-4xl shadow-sm border border-slate-100 p-8 md:p-10">
              ...
              <div className="relative">
                <div className="absolute left-5.75 top-4 bottom-4 w-0.5 bg-slate-100"></div>
