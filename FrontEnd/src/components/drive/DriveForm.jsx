...
const DriveForm = ({ initialData, onSubmit, title, loading }) => {
  ...
  // Input styles
  const labelStyle =
    "block text-xs font-bold uppercase tracking-wider text-slate-500 mb-2 ml-1";
  const inputStyle =
    "w-full p-4 bg-slate-50 border border-slate-200 rounded-xl focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-medium text-slate-900 placeholder:text-slate-400";
  const errorStyle =
    "text-red-500 text-xs mt-2 ml-1 font-bold flex items-center before:content-['•'] before:mr-1 before:text-lg";

  return (
    <div className="min-h-screen bg-[#F8FAFC]">
      {/* Background Decoration */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-0 right-0 w-150 h-150 bg-indigo-500/5 rounded-full blur-[100px]" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-10">
          ...
          <motion.section
            ...
            className="bg-white p-8 md:p-10 rounded-4xl shadow-[0_4px_20px_rgb(0,0,0,0.02)] border border-slate-100"
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">
                  Define the organization and job details.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                />
                {errors.companyName && (
                  <p className={errorStyle}>{errors.companyName.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.jobRole && (
                  <p className={errorStyle}>{errors.jobRole.message}</p>
                )}
              </div>
              ...
              <div className="md:col-span-2">
                ...
                {errors.jobDescription && (
                  <p className={errorStyle}>{errors.jobDescription.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.ctc && (
                  <p className={errorStyle}>{errors.ctc.message}</p>
                )}
              </div>
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">
                  Set important dates for the recruitment process.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="md:col-span-2">
                ...
                />
                {errors.driveTitle && (
                  <p className={errorStyle}>{errors.driveTitle.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.startDate && (
                  <p className={errorStyle}>{errors.startDate.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.endDate && (
                  <p className={errorStyle}>{errors.endDate.message}</p>
                )}
              </div>
          ...
          >
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                ...
                <p className="text-slate-500 text-sm font-medium">
                  Define who can apply for this role.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                />
                {errors.minCgpa && (
                  <p className={errorStyle}>{errors.minCgpa.message}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.passingYear && (
                  <p className={errorStyle}>{errors.passingYear.message}</p>
                )}
              </div>
              ...
              <div className="flex items-center gap-4 mt-2 p-4 bg-emerald-50 rounded-xl border border-emerald-100 w-fit">
                ...
                />
                <label
                  htmlFor="backlogsAllowed"
                  className="text-sm font-bold text-emerald-800 cursor-pointer select-none"
                >
          ...
          >
            ...
            <div>
              ...
              {errors.registrationLink && (
                <p className={errorStyle}>{errors.registrationLink.message}</p>
              )}
            </div>
          </motion.section>
        </form>
